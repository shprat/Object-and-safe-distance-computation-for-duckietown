...
class CameraSubscriberNode:
    ...
    def __init__(self):
        ...
        weights='runs/train/yolov5s_results6/weights/best.pt'  # model.pt path(s)
        ...
        self.image_pub = rospy.Publisher('detections', Image, queue_size=10)
        self.subscription = rospy.Subscriber('/duckduckgopls/camera_node/image/compressed', Image, self.camera_callback, queue_size=10)
